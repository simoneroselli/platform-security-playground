...
| **Container Hardening** | [Prevent Container Privilege Escalation](./01-container-hardening/03-prevent-privilege-escalation/README.md) | Blocking dynamic UID elevation. |- [Platform Security Playground 🧪](#platform-security-playground-)
